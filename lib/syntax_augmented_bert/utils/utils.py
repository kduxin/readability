...
from .srl_utils import write_conll_formatted_tags_to_file, convert_bio_tags_to_conll_format
...
class OntoNotesSRLProcessor(DataProcessor):
    ...
    def get_unk_examples(self, data_path):
        return self._create_examples(
            self._read_json(data_path), 'unk')
